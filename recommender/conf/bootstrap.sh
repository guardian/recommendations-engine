...
aws s3 cp s3://recommendations-dist/$stagetag/recommender/mobile-recommender.properties /etc/gu/$apptag.properties
cp /$apptag-1.0-SNAPSHOT/conf/init.conf /etc/init/recommender.conf
